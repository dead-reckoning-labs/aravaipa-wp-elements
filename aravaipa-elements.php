 ...
 * Description:       Custom Cornerstone elements for aravaiparunning.com: race hero, distance cards, event timeline, partner grid and countdown. Replaces the hand-built blocks currently rebuilt on every race page.
 * Version:           0.1.0
...
define( 'ARV_ELEMENTS_VERSION', '0.1.0' );
